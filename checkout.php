...
if (isset($_REQUEST["customer_id"]))
{
    ...
    //clear cart
//    unset($_SESSION["products"]);  removes the session completely
    $_SESSION["products"] =[];
}
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php foreach ($rows as $product): ?>
                    <tr>
                        ...
                        <td><img src="<?= $product['poster'] ?>" width="40" height="40" alt=""></td>
                        <td><a class="btn btn-danger btn-sm" href="checkout.php?id=<?= $product["id"] ?>"> Remove
                            </a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
